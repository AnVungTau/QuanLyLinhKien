...
//					tableLoaiLK.updateUI();
		...
		if (o.equals(btnLoc)) {
			if(cbLocLinhKien.getSelectedIndex() == 0 ) {
				GD_LinhKien form= new GD_LinhKien();
				this.setVisible(false);
				form.setVisible(true);
//				cbLocLinhKien.getSelectedItem();
			}
			if(cbLocLinhKien.getSelectedIndex() == 1) {
//				setPanel(new GD_LoaiLinhKien());
				GD_LoaiLinhKien form= new GD_LoaiLinhKien();
				this.setVisible(false);
				form.setVisible(true);
//				cbLocLinhKien.getSelectedItem();
			}
			if(cbLocLinhKien.getSelectedIndex() == 2) {
//				setPanel(new GD_NhaCungCap());
				GD_NhaCungCap form= new GD_NhaCungCap();
				this.setVisible(false);
				form.setVisible(true);
//				cbLocLinhKien.getSelectedItem();
			}
